...
function verifyEnvironment() {
	if (window.self === window.top) {
		...
		// EDIT: Uncommented the following line to ensure that layout switches to full layout when opening individual .htm files
...
function highlightDocument()
{
	...
	/* EDIT: Added check for empty topicNode */
	var topicNode;
	if (gTopicElemId != "")
		topicNode = document.getElementById(gTopicElemId);
	/* EDIT END */
	if(!topicNode)
