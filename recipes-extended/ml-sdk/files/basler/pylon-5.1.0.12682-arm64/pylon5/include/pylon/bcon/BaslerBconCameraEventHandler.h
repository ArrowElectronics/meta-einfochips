...
#ifndef INCLUDED_BCON_CAMERAEVENTHANDLER_H
#define INCLUDED_BCON_CAMERAEVENTHANDLER_H
...
namespace Pylon
{
    ...
    /**
    \class  CBaslerBconCameraEventHandler
    ...
    */
    ...
    public:
        ...
        */
        virtual void OnCameraEvent( CBaslerBconInstantCamera& camera, intptr_t userProvidedId, GenApi::INode* pNode)
        {
        }
        ...
        \param[in]  userProvidedId  This ID is passed as a parameter in CBaslerBconCameraEventHandler::OnCameraEvent and can be used to distinguish between different events.
        ...
        */
        virtual void OnCameraEventHandlerRegistered( CBaslerBconInstantCamera& camera, const String_t& nodeName, intptr_t userProvidedId)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera event handler registry.
        */
        virtual void OnCameraEventHandlerDeregistered( CBaslerBconInstantCamera& camera, const String_t& nodeName, intptr_t userProvidedId)
        {
        }
        ...
        */
        ...
        /// Create.
        CBaslerBconCameraEventHandler()
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Copy.
        CBaslerBconCameraEventHandler(const CBaslerBconCameraEventHandler&)
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Assign.
        CBaslerBconCameraEventHandler& operator=(const CBaslerBconCameraEventHandler&)
        {
            return *this;
        }

        /// Destruct.
        virtual ~CBaslerBconCameraEventHandler()
        {
...
#endif /* INCLUDED_BCON_CAMERAEVENTHANDLER_H */
