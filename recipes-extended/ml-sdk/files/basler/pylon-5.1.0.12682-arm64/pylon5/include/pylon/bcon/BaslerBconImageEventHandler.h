...
#ifndef INCLUDED_BCON_IMAGEEVENTHANDLER_H
#define INCLUDED_BCON_IMAGEEVENTHANDLER_H
...
namespace Pylon
{
    ...
    /**
    \class  CBaslerBconImageEventHandler
    ...
    */
    ...
    public:
        ...
        */
        virtual void OnImagesSkipped( CBaslerBconInstantCamera& camera, size_t countOfSkippedImages)
        {
        }
        ...
        \threading
            This method is called outside the lock of the camera object but inside the lock of the image event handler registry.
        */
        virtual void OnImageGrabbed( CBaslerBconInstantCamera& camera, const CBaslerBconGrabResultPtr& grabResult)
        {
        }
        ...
        */
        virtual void OnImageEventHandlerRegistered( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the image event handler registry.
        */
        virtual void OnImageEventHandlerDeregistered( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        */
        ...
        /// Create.
        CBaslerBconImageEventHandler()
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Copy.
        CBaslerBconImageEventHandler(const CBaslerBconImageEventHandler&)
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Assign.
        CBaslerBconImageEventHandler& operator=(const CBaslerBconImageEventHandler&)
        {
            return *this;
        }

        /// Destruct.
        virtual ~CBaslerBconImageEventHandler()
        {
...
#endif /* INCLUDED_BCON_IMAGEEVENTHANDLER_H */
