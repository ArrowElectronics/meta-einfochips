...
#ifndef INCLUDED_BCON_CONFIGURATIONEVENTHANDLER_H
#define INCLUDED_BCON_CONFIGURATIONEVENTHANDLER_H
...
namespace Pylon
{
    ...
    /**
    \class  CBaslerBconConfigurationEventHandler
    ...
    */
    ...
    public:
        ...
        */
        virtual void OnAttach( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnAttached( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDetach( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDetached( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDestroy( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDestroyed( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnOpen( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnOpened( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnClose( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnClosed( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStart( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStarted( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStop( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStopped( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabError( CBaslerBconInstantCamera& camera, const char* errorMessage)
        {
        }
        ...
        */
        virtual void OnCameraDeviceRemoved( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnConfigurationRegistered( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnConfigurationDeregistered( CBaslerBconInstantCamera& camera)
        {
        }
        ...
        */
        ...
        /// Create.
        CBaslerBconConfigurationEventHandler()
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Copy.
        CBaslerBconConfigurationEventHandler(const CBaslerBconConfigurationEventHandler&)
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Assign.
        CBaslerBconConfigurationEventHandler& operator=(const CBaslerBconConfigurationEventHandler&)
        {
            return *this;
        }

        /// Destruct.
        virtual ~CBaslerBconConfigurationEventHandler()
        {
...
#endif /* INCLUDED_BCON_CONFIGURATIONEVENTHANDLER_H */
